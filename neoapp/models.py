...
class Customer (models.Model):
    ...
    def cpf_view(self):
        ...
        if exposed_request.user.has_perm('neoapp.detokenize_cpf'):
            ...
            http = requests
            res = http.post('https://vts.neotel.com.br/vts/rest/v2.0/detokenize', data=json.dumps(data),
                            auth=('demo.detokem', '!3BananaAmassada'), verify=False)
            ...
            data = {"tokengroup": "demo.tokem", "token": self.CPF, "tokentemplate": "CPF"}
    ...
    def save(self, *args, **kwargs):
        ...
        if  not self.id:
            ...
            try:
                ...
                data = {"tokengroup" : "demo.tokem" ,"data" : self.CPF, "tokentemplate" : "CPF"}
...
class PayInfo(models.Model):
    ...
    def card_view(self):
        ...
        if exposed_request.user.has_perm('neoapp.detokenize_card'):
            ...
            http = requests
            res = http.post('https://vts.neotel.com.br/vts/rest/v2.0/detokenize', data=json.dumps(data),
                            auth=('demo.detokem.cc', '!3BananaAmassada'), verify=False)
            ...
            http = requests
            res = http.post('https://vts.neotel.com.br/vts/rest/v2.0/detokenize', data=json.dumps(data),
                            auth=('demo.tokem.cc', '!3BananaAmassada'), verify=False)
